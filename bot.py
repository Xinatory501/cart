...
from middlewares.debug_logger import DebugLoggerMiddleware
...
async def main():
    ...
    dp.message.outer_middleware(DebugLoggerMiddleware())
    ...
    await site.start()
    logger.info("HTTP API server started on http://0.0.0.0:8080")
